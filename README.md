...
**경기와 인플레이션의 방향을 읽고, 매월 투자할 ETF를 결정합니다.**
...
- **판단 근거가 명확합니다.** 가격 추세, 기대인플레이션, 섹터 상대성과로 신호를 계산합니다.
- **월말에 운용을 점검합니다.** 매일 매매할 필요 없이 월 단위로 목표 포지션을 확인합니다.
- **성과와 비용을 함께 봅니다.** 수익률뿐 아니라 낙폭, SPY 대비 상대성과, 매매비용의 영향을 비교합니다.
- **분석을 운용 기록으로 연결합니다.** 자동 데이터 갱신, 신호 저장, 모의 포트폴리오와 수동 거래 기록을 지원합니다.
...
*화면은 2026-09-13 캡처이며 마지막 가격은 2026-08-12입니다. 실행 성공 표시와 데이터 최신성은 별도로 확인합니다.*
